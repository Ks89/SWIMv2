...
public interface GestioneCollaborazioniInterface {
	...
	/**
	 * Metodo per ottenere la lista delle collaborazione/richieste di aiuto fatte dall'utente richiedente ed accettate da quello ricevente
	 * (cioe' dataStipula!=null) con l'attributo notificaAlRichiedente==false.
	 * Quindi questo metodo da le notifiche di accettazione delle richieste di aiuto fatte dal richiedente ai riceventi.
	 ...
	 * collaborazioni accettate dagli utenti riceventi, cioe' le richieste di aiuto fatte dall'utente richiedente e confermate/accettare
	 * dagli utenti riceventi identificati da utenteRicevente.
	 * Se non e' possibile ottenere tale lista, reistituisce <b>null</b>.
	 * @throws CollaborazioneException con causa ALCUNIPARAMETRINULLIOVUOTI
	 */
	...
	/**
	 * Metodo che pue' essere utilizzato per indicare come notificata al richiedente. Cioe' quando l'utente ricevente
	 * accetta la richiesta di aiuto viene impostato notificaAlRichiedente=false. Quando l'utente richiedente accede al suo profilo
	 * puo' usare il metodo per ottenere la lista delle collaborazioni accettate dall'utente ricevente (cioe' che hanno notificaAlRichiedente=false),
	 * a questo punto puo' usare setCollaborazioneNotificata() per impostare come viste quelle richieste d'aiuto e far si che non appaiano
	 * piu' le notifiche.
	 * @param id = Long che rappresenta l'id della collaborazione
	 * @return <b>collaborazione</b> se l'aggiornamento e' stata effettuto correttamente, <b>null</b> altrimenti
	 * @throws CollaborazioneException con causa ALCUNIPARAMETRINULLIOVUOTI
	 */
