...
<section>
	<div align="center" class="alignCenter">
		...
		<c:if test="${!empty erroreNomeAbilitaVuoto}">
			<div class="alert">
				<p>
					<c:out value="${erroreNomeAbilitaVuoto}"></c:out>
				</p>
			</div>
			<br>
		</c:if>
		...
		<form id="aggiuntaAbilitaForm" action="admin/aggiuntaAbilita" method="POST">
			<table id="formInserimentoParametri">
				<tr>
					...
					<td><input id="nuovoNomeAbilitaAggiunta" type="text" name="nuovoNomeAbilitaAggiunta" style="width: 271px;" maxlength="100"
						placeholder="Nome dell'abilita"></input></td>
				</tr>
				<tr>
					<td id="grassettoBlu">Descrizione (max: 300):</td>
					<td><textarea id="descrizioneAbilitaAggiunta" name="descrizioneAbilitaAggiunta" rows="10" cols="50" maxlength="300" style="resize: none;"
				...
				<tr>
					<td colspan="2" style="text-align: center;">
						 ...
						 <input type=button value="Invia" onClick="
								...
								{ 
									aggiuntaAbilitaForm.elements['conferma'].value='CONFERMA';
								}
								else {
									aggiuntaAbilitaForm.elements['conferma'].value='ANNULLA'; 
								}
						 		aggiuntaAbilitaForm.submit(); 
						 	"/>
		...
		<br>
		<br> <a href="admin">Torna al pannello di amministrazione</a>
	</div>
